...
SMMID::Exception - expressive exception object for web applications

=head1 SYNOPSIS

  die SMMID::Exception->new(
...
The SMMID::Exception object is meant to hold a wide variety of
